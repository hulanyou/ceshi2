...
// 医院类型
var suData2 = [
    {'id': '10001', 'value': '40','parentId': '0'},
    {'id': '10002', 'value': '41','parentId': '0'},
    {'id': '10003', 'value': '42','parentId': '0'},
    {'id': '10004', 'value': '43','parentId': '0'},
    {'id': '10005', 'value': '44','parentId': '0'},
];
var weiData2 = [
    {'id': '20001', 'value': '.0kg','parentId':'10001'},
    {'id': '20002', 'value': '.1kg','parentId':'10001'},
    {'id': '20003', 'value': '.2kg','parentId':'10001'},
    {'id': '20004', 'value': '.3kg','parentId':'10001'},
    {'id': '20005', 'value': '.4kg','parentId':'10001'},
    {'id': '20006', 'value': '.5kg','parentId':'10001'},

    {'id': '20007', 'value': '.6kg','parentId':'10001'},
    {'id': '20008', 'value': '.7kg','parentId':'10001'},
    {'id': '20009', 'value': '.8kg','parentId':'10001'},
    {'id': '20010', 'value': '.9kg','parentId':'10001'},
];
...
var starttime = [
    {'id': '10001', 'value': '00:00'},
    {'id': '10002', 'value': '01:00'},
    {'id': '10003', 'value': '02:00'},
    {'id': '10004', 'value': '03:00'},
    {'id': '10005', 'value': '04:00'},
    {'id': '10006', 'value': '05:00'},
];
var endtime = [
    {'id': '10001', 'value': '14:00'},
    {'id': '10002', 'value': '15:00'},
    {'id': '10003', 'value': '16:00'},
    {'id': '10004', 'value': '17:00'},
    {'id': '10005', 'value': '18:00'},
    {'id': '10006', 'value': '19:00'},
];
...
// 退货原因  退款原因-已收到货
var refund = [
    {'id': '10001', 'value': '大小尺寸与商品描述不符'},
    {'id': '10002', 'value': '卖家发错货'},
    {'id': '10003', 'value': '尺码拍错/不喜欢/效果差'},
    {'id': '10004', 'value': '假冒品牌'},
    {'id': '10005', 'value': '收到商品少件货破损'},
    {'id': '10006', 'value': '其他'}
];
// 医院
var hospital = [
    {'id': '10001', 'value': '北京协和医学院'},
    {'id': '10002', 'value': '北京医院'},
    {'id': '10003', 'value': '阜外心脑血管医院'},
    {'id': '10004', 'value': '201医院'}
];
// 退款原因-未收到货
var refund2 = [
    {'id': '10001', 'value': '多拍/拍错/不想要'},
    {'id': '10002', 'value': '快递无跟踪记录'},
    {'id': '10003', 'value': '快递一直未送到'},
    {'id': '10004', 'value': '空包裹/少货'},
    {'id': '10005', 'value': '未按约定时间发货'},
    {'id': '10006', 'value': '其他'}
];
...
// 所在科室
var duData = [
    {'id': '10001', 'value': '内科','parentId': '0'},
    {'id': '10002', 'value': '骨科','parentId': '0'},
    {'id': '10003', 'value': '妇产科','parentId': '0'},
    {'id': '10004', 'value': '儿科','parentId': '0'},
    {'id': '10005', 'value': '眼科','parentId': '0'},
    {'id': '10006', 'value': '耳鼻咽喉科','parentId': '0'},
    {'id': '10007', 'value': '肿瘤科','parentId': '0'}
];
var deiData = [
    {'id': '20001', 'value': '心血管内科','parentId':'10001'},
    {'id': '20002', 'value': '消化内科','parentId':'10001'},
    {'id': '20003', 'value': '呼吸内科','parentId':'10001'},
    {'id': '20004', 'value': '肾内科','parentId':'10001'},
    {'id': '20005', 'value': '血液病科','parentId':'10001'},
    {'id': '20006', 'value': '风湿免疫科','parentId':'10001'},

    {'id': '20007', 'value': '骨科','parentId':'10002'},
    {'id': '20008', 'value': '妇产科','parentId':'10003'},
    {'id': '20009', 'value': '儿科','parentId':'10004'},
    {'id': '20010', 'value': '眼科','parentId':'10005'},
    {'id': '20011', 'value': '耳鼻咽喉科','parentId':'10006'},
    {'id': '20012', 'value': '肿瘤科','parentId':'10007'}
];


// 发布类型
var spType = [
    {'id': '10001', 'value': '实物类商品'},
    {'id': '10002', 'value': '服务类商品'},
    {'id': '10003', 'value': '药品商品'}
];
// 仓库类型
var depotType = [
...
// 供应商类型
var gyType = [
    {'id': '10001', 'value': '药品供应商'},
    {'id': '10002', 'value': '服务供应商'},
];
...
// 医院类型
var suData = [
    {'id': '10001', 'value': '国内医院','parentId': '0'},
    {'id': '10002', 'value': '美国医院','parentId': '0'},
    {'id': '10003', 'value': '欧洲医院','parentId': '0'},
    {'id': '10004', 'value': '日本医院','parentId': '0'},
    {'id': '10005', 'value': '韩国医院','parentId': '0'},
    {'id': '10006', 'value': '其他国际医院','parentId': '0'},
];
var weiData = [
    {'id': '20001', 'value': '综合性医院','parentId':'10001'},
    {'id': '20002', 'value': '妇产科医院','parentId':'10001'},
    {'id': '20003', 'value': '儿童医院','parentId':'10001'},
    {'id': '20004', 'value': '老年医院','parentId':'10001'},
    {'id': '20005', 'value': '口腔医院','parentId':'10001'},
    {'id': '20006', 'value': '眼科医院','parentId':'10001'},

    {'id': '20007', 'value': '','parentId':'10002'},
    {'id': '20008', 'value': '','parentId':'10003'},
    {'id': '20009', 'value': '','parentId':'10004'},
    {'id': '20010', 'value': '','parentId':'10005'},
    {'id': '20011', 'value': '','parentId':'10006'},
    {'id': '20012', 'value': '','parentId':'10007'}
];

// 街道列表
var streetList = [
    {'id': '110101001', 'value': '东华门街道',"parentId":"110101"},
    {'id': '110101002', 'value': '景山街道',"parentId":"110101"},
    {'id': '110101003', 'value': '交道口街道',"parentId":"110101"},
    {'id': '110101004', 'value': '安定门街道',"parentId":"110101"},
    {'id': '110101005', 'value': '北新桥街道',"parentId":"110101"},
    {'id': '110101006', 'value': '东四街道',"parentId":"110101"}
];
// 省份列表
var iosProvinces = [
    /*******华北五省********/
